...
public class ComputerPage extends Utility {
    ...
    By softWareLink = By.id("product_attribute_5_10");
    By softWareLink2 = By.id("product_attribute_5_12");
    By price = By.id("price-value-1");
    By addToCartButton = By.id("add-to-cart-button-1");
    By productAddText  =  By.xpath("//body/div[@id='bar-notification']/div[1]/p[1]");
    ...
    public String verifyProductAddToText(){
        return getTextFromElement(productAddText);
    }
